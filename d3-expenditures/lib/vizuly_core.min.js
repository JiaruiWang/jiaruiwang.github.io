...
vizuly.color={},
vizuly.color.shift=function(a,b){
	return a="0x"+a.replace("#",""),
		   a=parseInt(a,16),
		   a+=65793,
		   a|=b,
		   "#"+a.toString(16)
...
vizuly.component.create=function(a,b,c,d){
	b.parent=a,b.properties=c,
	b.id=vizuly.util.guid(),
	b.selection=d3.select(a).
	append("div")
	.attr("id","div_"+b.id)
	.style("width","100%")
	.style("height","100%");
	...
	e.push("measure"),
	e.push("update"),
	Object.getOwnPropertyNames(c).forEach(function(a,b,c){
		e.push(a+"_change")}),
	d&&d.length>0&&d.forEach(function(a){e.push(a)}),
	...
	return setProps=function(a,b,c){
		Object.getOwnPropertyNames(c).forEach(function(d,e,f){
			"undefined"==typeof b[d]&&(b[d]=c[d],a[d]=function(c){
				...
				var e=b[d];
				return b[d]=c,
				b[d]!==e&&b.dispatch[d+"_change"].apply(this,[b[d],e]),a
			})
		})
	},
	f.id=function(){
	...
	f.validate=function(){
		if(!a){
			...
			if(Object.getOwnPropertyNames(c).forEach(function(c){
				...
				a.length>0)throw new Error("vizuly.util.component.validate(): "+a.concat()+" need to be declared");b.dispatch.validate()}},b.dispatch.component=f(),b.dispatch.component},



	vizuly.data={},
	vizuly.data.aggregateNest=function(a,b,c)
	{
		function d(a,b)
		{
			if(b)
				...
				{
					var d=g[c];
					void 0!=a[d]&&(a["childProp_"+d]=a[d]),
					b["childProp_"+d]=a["childProp_"+d]?a["childProp_"+d]:a[d]
				}
		}
		function e(a,f)
		{
...
var j,k={
Axiis:{name:"Axiis",label_color:"#333",
...
node_fill:function(a,b){return a.vz_link_color},node_fill_opacity:function(b,c){return a.value()(b)<=0?.15:.4},
node_stroke:function(a,b){return a.vz_link_color},node_stroke_opacity:function(a,b){return.6},
text_fill_opacity:function(b,c){return a.value()(b)<=0?.35:1},font_size:function(){return j+"px"}},

None:{name:"None",label_color:null,
link_colors:["#bd0026","#fecc5c","#fd8d3c","#f03b20","#B02D5D","#9B2C67","#982B9A","#692DA7",
	"#5725AA","#4823AF","#d7b5d8","#dd1c77","#5A0C7A","#5A0C7A"],
